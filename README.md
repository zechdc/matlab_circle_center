...
How it works
====================
Lets start with the scenario and show you the final results. Then I will go into detail about how the script works to achieve these results. 
...
How the script gets the final result
-----------
